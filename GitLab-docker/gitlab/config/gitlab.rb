...
gitlab_rails['db_password'] = "Pass2014"
gitlab_rails['db_host'] = "192.168.1.122"
...
gitlab_rails['redis_host'] = "192.168.1.122"  # "127.0.0.1"
...
gitlab_workhorse['listen_network'] = "tcp" # "unix"
# gitlab_workhorse['listen_umask'] = 000
gitlab_workhorse['listen_addr'] = "0.0.0.0:8081" # "/var/opt/gitlab/gitlab-workhorse/sockets/socket"
gitlab_workhorse['auth_backend'] = "https://localhost"
...
nginx['ssl_certificate'] = "/etc/letsencrypt/my_cert.crt"
nginx['ssl_certificate_key'] = "/etc/letsencrypt/my_key.key"
...
# letsencrypt['zeroxzed@gmail.com'] = [] # This should be an array of email addresses to add as contacts / contact_emails
...
# letsencrypt['auto_renew_minute'] = "50" # Should be a number or cron expression, if specified.
